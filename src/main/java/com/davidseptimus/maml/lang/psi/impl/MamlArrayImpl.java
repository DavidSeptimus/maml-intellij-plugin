...
public class MamlArrayImpl extends ASTWrapperPsiElement implements MamlArray {

  public MamlArrayImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MamlItems getItems() {
    return findChildByClass(MamlItems.class);
  }
