...
public class MamlObjectImpl extends ASTWrapperPsiElement implements MamlObject {

  public MamlObjectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MamlMembers getMembers() {
    return findChildByClass(MamlMembers.class);
  }
